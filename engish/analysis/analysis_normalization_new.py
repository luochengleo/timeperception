...
def compute_pairwise_agreement():
    ...
    fout.write(
        "studentid,m1-m2-R-R,m1-m2-R-I,m1-m2-I-I,m1-m2-total,m1-m3-R-R,m1-m3-R-I,m1-m3-I-I,m1-m3-total,m2-m3-R-R,m2-m3-R-I,m2-m3-I-I,m2-m3-total,m1-R-R,m1-R-I,m1-I-I,m2-R-R,m2-R-I,m2-I-I,m3-R-R,m3-R-I,m3-I-I")
    fout.write('\n')
    for studentid in validUsers:
        ...
        items = [
            ...
            float(rr_e1e2_agree_num_all_tasks + ri_e1e2_agree_num_all_tasks + ii_e1e2_agree_num_all_tasks) / float(
                rr_e1e2_total_num_all_tasks + ri_e1e2_total_num_all_tasks + ii_e1e2_total_num_all_tasks),
            ...
            float(rr_e1e3_agree_num_all_tasks + ri_e1e3_agree_num_all_tasks + ii_e1e3_agree_num_all_tasks) / float(
                rr_e1e3_total_num_all_tasks + ri_e1e3_total_num_all_tasks + ii_e1e3_total_num_all_tasks),
            ...
            float(rr_e2e3_agree_num_all_tasks + ri_e2e3_agree_num_all_tasks + ii_e2e3_agree_num_all_tasks) / float(
                rr_e2e3_total_num_all_tasks + ri_e2e3_total_num_all_tasks + ii_e2e3_total_num_all_tasks),
    ...
    for time_method in ['segments', 'range', 'relative']:
        for j in ['2', '3', '4', '5']:
            ...
            print time_method, j, np.mean(ri_perceived_drifts[time_method][j]), np.std(
                ri_perceived_drifts[time_method][j]), stats.ttest_1samp(ri_perceived_drifts[time_method][j], 1)[1]
            print time_method, j, np.mean(rr_perceived_drifts[time_method][j]), np.std(
                rr_perceived_drifts[time_method][j]), stats.ttest_1samp(rr_perceived_drifts[time_method][j], 1)[1]
            print time_method, j, np.mean(ii_perceived_drifts[time_method][j]), np.std(
                ii_perceived_drifts[time_method][j]), stats.ttest_1samp(ii_perceived_drifts[time_method][j], 1)[1]
